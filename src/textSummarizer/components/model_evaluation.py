...
class ModelEvaluation:
    ...
    def calculate_metric_on_test_ds(self, dataset, metric, model, tokenizer,
        ...
        for article_batch, target_batch in tqdm(
            ...
            ''' parameter for length penalty ensures that the model does not be generate sequences'''
            ...
            decoded_suammries = [d.replace("", " ") for d in decoded_summaries]

            metric.add_batch(predictions=decoded_suammries, references=target_batch)
